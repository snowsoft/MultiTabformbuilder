...
abstract class TraitTestCase extends FormTestCase {
    ...
    public function setUp()
    {
        ...
        User::create(['name' => 'John', 'email' => 'email@test', 'status' => \Snowsoft\MultiTabFormBuilder\Helpers\StaticLabel::STATUS_ONLINE]);
    }
...
class FormController extends \Illuminate\Routing\Controller implements \Snowsoft\MultiTabFormBuilder\Contracts\FormStateContract {

    use \Snowsoft\MultiTabFormBuilder\States\FormStateTrait;
    ...
    public function getEditSelected($id = '')
    {
        ...
        $form_content = view('multi-tab-form-builder::form.components.formgenerator.full', [
            'form' => $form
        ]);
...
class TestValidatorForm extends FormValidator {
    ...
    public function buildForm()
    {
        $this
            ...
            ->add('status', 'choice', [
                'choices'     => \Snowsoft\MultiTabFormBuilder\Helpers\StaticLabel::yesNo(),
                'empty_value' => '-',
                'validation'  => 'required',
                'selected'    => \Snowsoft\MultiTabFormBuilder\Helpers\StaticLabel::STATUS_ONLINE,
                'label'       => 'status'
            ]);
...
class ValidationFormController extends \Illuminate\Routing\Controller implements \Snowsoft\MultiTabFormBuilder\Contracts\FormStateContract {
...
class SaveFormController extends \Illuminate\Routing\Controller implements \Snowsoft\MultiTabFormBuilder\Contracts\FormStateContract {
...
class AfterSaveFormController extends \Illuminate\Routing\Controller implements \Snowsoft\MultiTabFormBuilder\Contracts\FormStateContract {
