...
class FieldController extends \Illuminate\Routing\Controller {
    ...
    public function postIndex(Request $request)
    {
        ...
        $form = app('Snowsoft\MultiTabFormBuilder\FormValidator')
        ...
        $form_content = view('multi-tab-form-builder::form.components.formgenerator.info_all', [
            'form' => $form
        ]);

        return view('multi-tab-form-builder::form.state.form', [
            'form' => $form_content
        ]);
