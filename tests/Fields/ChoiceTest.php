...
class ChoiceTest extends FieldTestCase {
    ...
    public function testChoiceAreaRender()
    {
        ...
        $this->assertInstanceOf('Snowsoft\MultiTabFormBuilder\Fields\ChoiceArea', $field);
    }
    ...
    public function testRadioRender(){
        ...
        $this->assertInstanceOf('Snowsoft\MultiTabFormBuilder\Fields\ChoiceType', $field);
    }
    ...
    public function testSelectTypeRender(){
        ...
        $form  = $response->original->getData()['form']->getData()['form'];
        $field = $form->getField('choice_content');
        $this->assertInstanceOf('Snowsoft\MultiTabFormBuilder\Fields\SelectType', $field);
    }
    ...
    public function testCheckTypeRender(){
        ...
        $form  = $response->original->getData()['form']->getData()['form'];
        $field = $form->getField('choice_content');
        $this->assertInstanceOf('Snowsoft\MultiTabFormBuilder\Fields\CheckableType', $field);
    }
    ...
    public function testChoiceAjaxRender(){
        ...
        $form  = $response->original->getData()['form']->getData()['form'];
        $field = $form->getField('choice_content');
        $this->assertInstanceOf('Snowsoft\MultiTabFormBuilder\Fields\ChoiceAjax', $field);
    }
}